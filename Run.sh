...
gem install lolcat
echo This Tool Is Created By HA_AN
echo This Script Is Created HA_AN Hackers hasanfq6 >update.pandahackers
...
echo -e "\e[1;32m        Mail: hasanfq818@gmail.com \e[0m" #yellow
...
echo -e "\e[1;33m      [*]  HA_AN hackers   \e[1;31m"
echo "         [-] Mail At: hasanfq818@gmail.com"
